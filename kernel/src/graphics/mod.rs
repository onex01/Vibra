/// Модуль графического API ядра Vibra OS
pub mod primitives;
pub mod color;
pub mod fps;
...
/// Таблица значений синуса: 256 входов, значения 0-255.
/// 128 = sin(0), 255 = sin(π/2), 1 = sin(3π/2).
...
/// Знаковый синус из таблицы (диапазон -127..127)
pub fn sin_lut(i: u8) -> i32 {
    SINE_LUT[i as usize] as i32 - 128
}

/// Знаковый косинус из таблицы (диапазон -127..127)
pub fn cos_lut(i: u8) -> i32 {
    SINE_LUT[i.wrapping_add(64) as usize] as i32 - 128
}
